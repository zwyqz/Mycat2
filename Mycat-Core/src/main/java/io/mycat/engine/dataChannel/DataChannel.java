...
public interface DataChannel {
	 ...
	 */
	public void transferToFront(MySQLConnection in, boolean transferFinish,boolean isAllFinish)throws IOException;
	 ...
	 * @param isAllFinish  是否全部透传完成
	 */
	public void transferToBackend(MySQLConnection in, boolean transferFinish,boolean isAllFinish)throws IOException;
